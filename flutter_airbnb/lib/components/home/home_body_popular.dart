...
class HomeBodyPopular extends StatelessWidget {
  ...
  Widget _buildPopularList() {
    ...
    // 2. _buildPopularList의 넒이는 화면의 70%이니까 700이다.
    // 3. HomeBodyPopularItem의 넓이는 700의 1/3인 233.33 - 5의 크기니까 총 228.33 이다.
    // 4. 288.33 의 인기 아이템이 3개가 배치되면 684.99 크기이고 남은 크기는 15.01이 남는다.
    // 5. 그래서 HomeBodyPopularItem 위젯 사이사이에 SizedBox를 7.5를 줄 수 있다.
    return Wrap(
      children: [
        // 6. id 값은 사진을 선택하기 위해 필요하다.
